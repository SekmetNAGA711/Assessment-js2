...
// let markDown = deals[0].title.replace(/15/g, '10')

// console.log(markDown)


deals[0].title = deals[0].title.replace(/15/g, '10')
console.log(deals)
...
//CODE HERE
deals[1].desc = deals[1].desc.replace(/March/g, 'April')
